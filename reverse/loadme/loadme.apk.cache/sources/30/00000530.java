...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        flagWidget.addTextChangedListener(new TextWatcher() { // from class: com.mobisec.dexclassloader.MainActivity.1
        ...
        checkButton.setOnClickListener(new View.OnClickListener() { // from class: com.mobisec.dexclassloader.MainActivity.2
