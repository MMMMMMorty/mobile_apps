...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static SetIndicatorInfo setActionBarUpIndicator(SetIndicatorInfo info, android.app.Activity activity, Drawable drawable, int contentDescRes) {
    ...
    public static SetIndicatorInfo setActionBarDescription(SetIndicatorInfo info, android.app.Activity activity, int contentDescRes) {
        if (info == null) {
    ...
    public static Drawable getThemeUpIndicator(android.app.Activity activity) {
